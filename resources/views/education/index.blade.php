...
<div class="py-10 lg:py-16 space-y-16">
    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-navy/10 border border-navy/20 text-navy text-xs font-bold uppercase tracking-wider mb-4">
    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6">
        <div class="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-[#2E2E2E] via-[#232323] to-[#0A315F] text-white text-center shadow-2xl relative overflow-hidden">
            ...
            <span class="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-white/10 border border-white/20 text-amber-200 text-xs font-bold uppercase tracking-wider mb-4">
                Dukungan & Bantuan
            </span>
