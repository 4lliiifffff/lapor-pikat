...
<head>
    ...
    <meta name="description"
        content="Layanan pelaporan perundungan (bullying) terpercaya dan rahasia untuk warga belajar PKBM Pintar Berbakat. Lapor secara anonim atau pakai data diri dengan pelacakan transparan.">
    ...
    <div class="bg-[#E63038] text-white text-xs sm:text-sm py-2 px-4 shadow-sm">
        <div class="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="https://wa.me/6282219082518" target="_blank" rel="noopener noreferrer"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-20">
                ...
                <a href="{{ route('reports.create') }}" class="flex items-center gap-3 group">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            <span class="font-extrabold text-lg sm:text-xl tracking-tight text-navy">Lapor<span
                                    class="text-[#E63038]">Aman</span></span>
                            <span
                                class="bg-navy/10 text-navy text-[10px] font-bold px-2 py-0.5 rounded-full border border-navy/20">PKBM
                                Pintar Berbakat</span>
                        </div>
                        <p class="text-[11px] text-brandGray hidden sm:block">Kanal Pengaduan & Edukasi Anti Perundungan
                        </p>
                    </div>
                </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div class="md:col-span-2 space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-xl font-bold text-white tracking-tight">Lapor<span
                                class="text-[#FBA239]">Aman</span> PKBM Pintar Berbakat</span>
                    </div>
                    <p class="text-slate-300 text-sm leading-relaxed max-w-md">
                        ...
                        menghargai, dan aman bagi seluruh warga belajar PKBM Pintar Berbakat. Semua aduan diproses
                ...
                <div class="space-y-3">
                    ...
                    <p class="text-xs text-slate-300">Tim Tanggap Perundungan PKBM Pintar Berbakat</p>
                    <a href="https://wa.me/6282219082518" target="_blank" rel="noopener noreferrer"
